 ...
 */
class Utilisateur extends \AD\GsbBundle\Entity\Utilisateur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AD\\GsbBundle\\Entity\\Utilisateur' . "\0" . 'id', '' . "\0" . 'AD\\GsbBundle\\Entity\\Utilisateur' . "\0" . 'nom', '' . "\0" . 'AD\\GsbBundle\\Entity\\Utilisateur' . "\0" . 'prenom', '' . "\0" . 'AD\\GsbBundle\\Entity\\Utilisateur' . "\0" . 'adresse', '' . "\0" . 'AD\\GsbBundle\\Entity\\Utilisateur' . "\0" . 'cp', '' . "\0" . 'AD\\GsbBundle\\Entity\\Utilisateur' . "\0" . 'ville', '' . "\0" . 'AD\\GsbBundle\\Entity\\Utilisateur' . "\0" . 'dateembauche');
        }
